		...
		begin
			for Alto:=1 to TColumna do
				begin
                    ...
                    until ((OpcionColumna>0) and (OpcionColumna<=9)) and ((OpcionFila>0) and (OpcionFila<=9)) and ((NumeroCasilla>0) and (NumeroCasilla<=9))
				end;
		end;
